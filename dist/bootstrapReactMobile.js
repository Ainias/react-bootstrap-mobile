...
function Clickable(_a, ref) {
  ...
  var {
    ...
    stopPropagation = true
      ...
      clickData = Clickable_rest(_a, ["className", "children", "style", "href", "interactable", "preventDefault", "stopPropagation"]); // States
  // Refs
  // Callbacks
  ...
  }, [clickData.onClickCapture, onClickCaptureInner, preventDefault, stopPropagation]); // Effects
  // Other
  // Render Functions
...
function Text(_a) {
  var {
    ...
    as = 'span'
      ...
      props = Text_rest(_a, ["className", "children", "block", "prio", "size", "as"]); // Variables


  prio = prio !== null && prio !== void 0 ? prio : (text_default()).primaryDefault; // States
  // Refs
  // Callbacks
  // Effects
  // Other
...
function DragItem_extends() { DragItem_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return DragItem_extends.apply(this, arguments); }
...
function DragItem(_a) {
  ...
  var {
    children
      ...
      dragProps = DragItem_rest(_a, ["children"]); // Refs
  // States
  // Selectors
  // Callbacks
  // Effects
...
function DropArea_extends() { DropArea_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return DropArea_extends.apply(this, arguments); }
...
function DropArea(_a) {
  ...
  var {
    ...
    className
      ...
      dropProps = DropArea_rest(_a, ["children", "style", "className"]); // Refs
  // States


  const enabled = useStrictEnabled(); // Selectors
  // Callbacks
  // Effects
  // Other
  // Render Functions
...
const Input = withForwardRef(function Input(_a, ref) {
  ...
  const innerRef = useComposedRef(ref); // Callbacks
  ...
  useOnChangeDone(onChangeDone, innerRef); // Other
  // Render Functions
...
const SearchSelectInput = withMemo(function SearchSelectInput({
  ...
  // Variables
  const indexedOptions = (0,external_react_.useMemo)(() => shared.ArrayHelper.arrayToObject(options, opt => opt.value), [options]); // Refs

  const containerRef = (0,external_react_.useRef)(null);
  const window = useWindow(); // States
  ...
  }, [suggestionsPosition, options, searchText, values]); // Selectors
  // Callbacks
  ...
  }, [toggleOption, selectableOptions, selectedIndex]); // Effects
  // Other
  // Render Functions
...
function Select(_a) {
  var {
    ...
    inline = false
      ...
      otherProps = Select_rest(_a, ["label", "options", "className", "style", "onChangeValue", "inline"]); // Variables


  console.log('LOG-d inline', inline); // Refs
  // States
  // Selectors
  // Callbacks
...
const Slider_Slider = withMemo(function Slider(_a) {
  ...
  var {
    ...
    style
      ...
      props = Slider_rest(_a, ["className", "style"]); // Refs
  // States
  // Selectors
  // Callbacks
  ...
  const innerOnChange = (0,external_react_.useCallback)(e => {
    ...
    onChange(e);
  }, [onChange, onChangeValue]); // Effects

  const innerRef = useOnChangeDone(onChangeDone); // Other
  // Render Functions
...
function FullScreen(_a) {
  ...
  }, [fullscreenKey, toggleFullscreen, window]); // Other
  // Render Functions
...
function useDelayed(callback, dependencies, delay = 100, maxDelay) {
  ...
  const mayDelayTimeoutRef = (0,external_react_.useRef)(undefined); // eslint-disable-next-line react-hooks/exhaustive-deps
...
function useKeyListener(key, listener, dependencies = [], ignoreFormElements = true) {
  ...
  (0,external_react_.useEffect)(() => {
    ...
    return () => window === null || window === void 0 ? void 0 : window.removeEventListener('keydown', keyListener); // eslint-disable-next-line react-hooks/exhaustive-deps
...
function SizeCalculator({
  ...
  // Variables
  // Refs
  const ref = (0,external_react_.useRef)(null); // States
  // Selectors
  // Callbacks
  // Effects
...
function List({
  ...
  // Variables
  // States
  const [itemHeight, setItemHeight] = (0,external_react_.useState)(initialItemHeight); // Refs
  // Callbacks
...
function Menu({
  ...
  (0,external_react_.useLayoutEffect)(() => {
    ...
    setInnerY(newY);
  }, [window === null || window === void 0 ? void 0 : window.innerHeight, y]); // Other
  // Render Functions
